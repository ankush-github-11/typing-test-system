  ...
  return (
    <>
      <div
        ...
        className={`${started || focused ? "" : "blur-md"} transition-all ${durationClass} ease-linear mt-[1px] h-[45px] w-[23px] border-2 border-color1 inline-block absolute rounded-sm ${cn}`}
      ></div>
    </>
  );
};
