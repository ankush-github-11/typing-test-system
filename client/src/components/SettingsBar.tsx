...
const SettingsNavbar = () => {
  ...
  return (
    <div className="z-10 group absolute right-0 top-1/2 -translate-y-1/2 h-fit w-15 hover:w-70 overflow-hidden transition-all duration-400 ease-in-out border-2 border-color1/80 border-r-0 rounded-bl-[50px] rounded-tl-[50px] flex flex-col p-5 gap-y-2 bg-black/3 dark:bg-white/3 backdrop-blur-md">
      <div className="flex flex-row opacity-25 w-fit gap-x-3 cursor-pointer">
        <div className="h-[30px] text-[17px] w-[30px] rounded-lg flex justify-center items-center bg-bgcolorless font-medium">
          #
        </div>
      ...
      <div>
        ...
        <div className="flex h-fit w-fit gap-x-3">
          <div className="activeTypingSetting cursor-pointer h-[30px] text-[16px] w-fit py-1 px-2 rounded-lg flex justify-center items-center text-textcolorless">
            15
          </div>
          <div className="cursor-pointer h-[30px] text-[16px] w-fit py-1 px-2 rounded-lg flex justify-center items-center font-medium hover:bg-lightgray text-textcolorless">
            30
          </div>
          <div className="cursor-pointer h-[30px] text-[16px] w-fit py-1 px-2 rounded-lg flex justify-center items-center font-medium hover:bg-lightgray text-textcolorless">
            60
      ...
      <div className="flex flex-row opacity-25 w-fit gap-x-3 cursor-pointer">
        <WandSparkles className="font-2xl h-[30px] p-[4.5px] pb-[7px] pt-[4px] text-[20px] w-[30px] rounded-lg flex justify-center items-center bg-bgcolorless" />
        <div className="h-[30px] text-textcolorless flex justify-center items-center">
          Freestyle
        </div>
      </div>
